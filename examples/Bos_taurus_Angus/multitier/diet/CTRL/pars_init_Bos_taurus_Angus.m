...
par.p_Am = 2133.9524997467324; free.p_Am = 1; units.p_Am = 'J/d.cm^2'; label.p_Am = 'Surface-specific maximum assimilation rate';
par.kap_X = 0.21712962240000422; free.kap_X = 1; units.kap_X = '-'; label.kap_X = 'digestion efficiency of food to reserve';
par.kap_P = 0.23817610163987085; free.kap_P = 1; units.kap_P = '-'; label.kap_P = 'faecation efficiency of food to faeces';
