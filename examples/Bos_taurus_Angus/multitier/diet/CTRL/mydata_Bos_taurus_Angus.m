...
tiers.tier_groups = struct('diet', {{}}, 'individual', {{'Pen_3', 'Pen_4'}}); units.tiers.tier_groups = '-'; label.tiers.tier_groups = 'List of groups ids for each tier'; 
...
tiers.tier_entities = struct('diet', {{'CTRL'}}, 'individual', {{'PT833653649', 'PT533843896', 'PT933843894', 'PT224401177', 'PT333842562', 'PT533987885', 'PT524401180', 'PT924401183', 'PT524956505', 'PT933602927'}}); units.tiers.tier_entities = '-'; label.tiers.tier_entities = 'List of entity ids for each tier'; 
...
tiers.groups_of_entity = struct('PT833653649', {{'Pen_3'}}, 'PT533843896', {{'Pen_4'}}, 'PT933843894', {{'Pen_3'}}, 'PT224401177', {{'Pen_4'}}, 'PT333842562', {{'Pen_3'}}, 'PT533987885', {{'Pen_3'}}, 'PT524401180', {{'Pen_3'}}, 'PT924401183', {{'Pen_4'}}, 'PT524956505', {{'Pen_4'}}, 'PT933602927', {{'Pen_4'}}); units.tiers.groups_of_entity = '-'; label.tiers.groups_of_entity = 'Groups each entity belongs to'; 
...
tiers.tier_subtree = struct('CTRL', struct('individual', {{'PT833653649', 'PT533843896', 'PT933843894', 'PT224401177', 'PT333842562', 'PT533987885', 'PT524401180', 'PT924401183', 'PT524956505', 'PT933602927'}})); units.tiers.tier_subtree = '-'; label.tiers.tier_subtree = 'Tier subtree'; 
...
metaData.tier_par_init_values = struct('p_Am', struct('CTRL', 2124.371378681546), 'kap_X', struct('CTRL', 0.21713680397830953)); 
