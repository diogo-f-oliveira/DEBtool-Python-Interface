...
tiers.tier_groups = struct('individual', {{'Pen_4'}}); units.tiers.tier_groups = '-'; label.tiers.tier_groups = 'List of groups ids for each tier'; 
...
tiers.tier_entities = struct('individual', {{'PT533843896', 'PT933602927', 'PT224401177', 'PT524956505', 'PT924401183'}}); units.tiers.tier_entities = '-'; label.tiers.tier_entities = 'List of entity ids for each tier'; 
...
tiers.groups_of_entity = struct('PT533843896', {{'Pen_4'}}, 'PT933602927', {{'Pen_4'}}, 'PT224401177', {{'Pen_4'}}, 'PT524956505', {{'Pen_4'}}, 'PT924401183', {{'Pen_4'}}); units.tiers.groups_of_entity = '-'; label.tiers.groups_of_entity = 'Groups each entity belongs to'; 
