...
par.p_Am = 2318.68324369343; free.p_Am = 1; units.p_Am = 'J/d.cm^2'; label.p_Am = 'Surface-specific maximum assimilation rate';
par.kap_X = 0.2201839668351898; free.kap_X = 1; units.kap_X = '-'; label.kap_X = 'digestion efficiency of food to reserve';
par.kap_P = 0.21562628687080732; free.kap_P = 0; units.kap_P = '-'; label.kap_P = 'faecation efficiency of food to faeces';
