...
2. [DEBTOOL_FILES.md](DEBTOOL_FILES.md) for the general DEBtool estimation-file structure.
3. [DEBTOOL_MULTITIER.md](DEBTOOL_MULTITIER.md) for how `DEBtoolPyIF` integrates the multitier methodology into those files.
4. [TEMPLATE_GENERATION.md](TEMPLATE_GENERATION.md) for how tier template folders are consumed and generated from Python.
...
3. Copy [DEBTOOL_FILES.md](DEBTOOL_FILES.md) into the project if agents or users need the general DEBtool file structure reference.
4. Copy [DEBTOOL_MULTITIER.md](DEBTOOL_MULTITIER.md) into the project if agents will generate or edit multitier MATLAB templates.
5. Copy [TEMPLATE_GENERATION.md](TEMPLATE_GENERATION.md) into the project if agents will debug Python-side code generation or generated tier outputs.
