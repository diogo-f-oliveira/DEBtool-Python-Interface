...
tiers.tier_groups = struct('individual', {{'Pen_4', 'Pen_4', 'Pen_4', 'Pen_4', 'Pen_4'}}); units.tiers.tier_groups = '-'; label.tiers.tier_groups = 'List of groups ids for each tier'; 
...
tiers.entity_list = {'PT224401177', 'PT524956505', 'PT533843896', 'PT924401183', 'PT933602927'}; units.tiers.entity_list = '-'; label.tiers.entity_list = 'List of entities'; 
...
tiers.tier_entities = struct('individual', {{'PT224401177', 'PT524956505', 'PT533843896', 'PT924401183', 'PT933602927'}}); units.tiers.tier_entities = '-'; label.tiers.tier_entities = 'List of entity ids for each tier'; 
...
tiers.groups_of_entity = struct('PT224401177', {{'Pen_4'}}, 'PT524956505', {{'Pen_4'}}, 'PT533843896', {{'Pen_4'}}, 'PT924401183', {{'Pen_4'}}, 'PT933602927', {{'Pen_4'}}); units.tiers.groups_of_entity = '-'; label.tiers.groups_of_entity = 'Groups each entity belongs to'; 
...
tiers.tier_subtree = struct('PT224401177', struct(), 'PT524956505', struct(), 'PT533843896', struct(), 'PT924401183', struct(), 'PT933602927', struct()); units.tiers.tier_subtree = '-'; label.tiers.tier_subtree = 'Tier subtree'; 
...
metaData.tier_par_init_values = struct('p_Am', struct('PT224401177', 2308.9050612470874, 'PT524956505', 2308.9050612470874, 'PT533843896', 2308.9050612470874, 'PT924401183', 2308.9050612470874, 'PT933602927', 2308.9050612470874), 'kap_X', struct('PT224401177', 0.22029769232546206, 'PT524956505', 0.22029769232546206, 'PT533843896', 0.22029769232546206, 'PT924401183', 0.22029769232546206, 'PT933602927', 0.22029769232546206)); 
